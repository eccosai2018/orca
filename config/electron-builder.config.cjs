...
module.exports = {
  ...
  // Why: 'orca' is a shared protocol constant (mobile pairing deep links,
  // web-pairing.ts, etc.) used throughout the codebase — not a display name,
  // left unrenamed per CLAUDE.md's protocol-constants rule.
