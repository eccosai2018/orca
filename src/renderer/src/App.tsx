              ...
              <ContextMenu>
                <ContextMenuTrigger asChild>
                  <div
                    ...
                    aria-label={translate('auto.App.5096cbbc86', 'Dark Factory')}
                  >
                    <span className="titlebar-app-name-main">
                      {translate('auto.App.5096cbbc86', 'Dark Factory')}
                    </span>
                  </div>
                </ContextMenuTrigger>
                <ContextMenuContent>
                        ...
                        <div className="flex flex-1 min-w-0 min-h-0 flex-col">
                          ...
                          <Suspense fallback={null}>
                            <RecoverableRenderErrorBoundary
                              ...
                              description={translate(
                                'auto.App.03a14f6b5b',
                                'Retry the page or navigate to another Dark Factory surface.'
                              )}
                            >
